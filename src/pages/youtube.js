...
<div className='player-wrapper' style={{position:'relative', width:'100vw',  top:'', border:'0px solid blue', zIndex:'3', height:'content-fill', overflow:'hidden' }}>
...
<div className="" style={{display:'block', justifyContent:'center', width:'100%', margin:'0 auto', flexDirection:'row', maxWidth:'1000px', border:'0px solid red', position:'relative', top:'-120px', height:'', zIndex:'66'}}>
...
<div className="" style={{display:'flex', justifyContent:'space-around', width:'100%', margin:'0 auto', flexDirection:'row', maxHeight:'80vh', border:'0px solid red'}}>
    <form className="youtubeform frontdrop" onSubmit={this.handleSubmit} style={{ padding:'2rem', border:'0px solid red', borderRadius:'12px', height:'50px', width:'100%', maxWidth:'90vw', margin:'5px auto', zIndex:'66', position:'relative', bottom:'0',transition:' all 1.85s', animation:'fade 1.5s forwards', display:'flex', justifyContent:'space-between', alignItems:'center'  }}>
