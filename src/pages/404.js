...
<StaticImage src="../img/moose.webp" alt="Todd builds Web Apps" style={{height:'auto', position:'fixed', top:'0', left:'0', zIndex:'-1', width:'100vw', maxHeight:'100vh',  objectFit:'cover', overflow:'', border:'0px solid red !important'}}  />
