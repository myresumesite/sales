...
<iframe title="VidSock" id="youtube2" className="blog-video1" width="100%" height="400" src="/admin/" frameBorder="0" playsInline  style={{position:'absolute', top:'0', left:'0', right:'0', zIndex:'0', width:'100%', height:'100vh', minHeight:'100vh', border:'0px solid yellow', borderRadius:'12px', padding:'70px 0 0 0' }} />
...
<div className="" style={{display:'flex', justifyContent:'space-around', width:'100%', margin:'0 auto', flexDirection:'row', maxHeight:'100vh'}}>
    ...
    <p onClick={this.handleHide} className="headline" style={{fontSize:'90%', color:'#fff', fontWeight:'bold', textAlign:'right', width:'250px', marginRight:'15px'}}>Pasted YouTube Link:
</p>
<input
      id=""
      type="text"
...
{/* <input name="" type="reset" value="Reset" /> */}
  ...
  {/* <div style={{position:'absolute', bottom:'0', zIndex:'55',border:'0px solid red', width:'500px', height:'20vh'}}>
